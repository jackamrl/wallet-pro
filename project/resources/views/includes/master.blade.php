            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if(Auth::guard('profile')->guest())
                        <li><a href="{{url('/account/login')}}" class="">Login</a></li>
                        <li><a href="{{url('/account/registration')}}" class="">Registration</a></li>
                    @else
                        <li><a href="{{url('/account/dashboard')}}" class="">My Account</a></li>
                    @endif
                </ul>
            </div>
        </div>
