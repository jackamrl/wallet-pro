    ...
    <div class="row">
        <div class="container">
            <div class="container">
                ...
                <form role="form" method="POST" action="{{ route('account.send.submit') }}">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group">
                                <input name="amount" placeholder="Send Amount" value="{{ old('amount') }}" class="form-control"  type="text" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <button type="submit" id="sbmtbtn" class="btn btn-ocean btn-block"><strong>Send</strong></button>
                        </div>
                    </div>
                </form>
