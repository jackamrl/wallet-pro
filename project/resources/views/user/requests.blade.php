                        ...
                        <div class="panel-body table-responsive">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger btn-sm" href="{{url('/account/rejectrequest')}}/{{$request->id}}">Reject</a>
                                        <button class="btn btn-success btn-sm" onclick="accept({{$request->id}})" data-toggle="modal" data-target="#myModal">Accept</button>
                                    </td>
                                </tr>
                                @empty
                                    <tr>
